package com.frog.study.mystream.test;

/**
 * @author haichao.shao (shaohaichao@shanshu.ai)
 * @since 2020/12/22
 */
import com.frog.study.mystream.stream.generator.CollectionStreamGenerator;
import com.frog.study.mystream.stream.utils.CollectUtils;
...
public class FlatMapTest {
    ...
    private static void testCollectionGenerator(){
        ...
        List<String> list = CollectionStreamGenerator.getListStream(playersInWorldCup2016)
